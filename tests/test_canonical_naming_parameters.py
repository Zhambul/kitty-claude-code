...
from tests.canonical_naming_parameter_support_one import _project_classes
from tests.canonical_naming_parameter_support_two import _parameter_name_violations
from tests.canonical_naming_paths import _module_paths


def test_a_parameter_is_named_after_its_class() -> None:
    """Verify a parameter is named after its class."""
    classes = _project_classes()
    violations = [violation for path in _module_paths() for violation in _parameter_name_violations(path, classes)]
